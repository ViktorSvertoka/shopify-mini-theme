  ...
  function renderGallery(start, end) {
    ...
    mainImage.innerHTML = `
      <img
        ...
        alt="Product image" 
        loading="lazy" 
        class="js-main-image w-468 h-[468px] object-cover block md:w-[536px] md:h-[536px]" 
      />
      `;
    ...
    thumbsImage.innerHTML = images
      .map(
        (img, idx) => `
        <div class="rounded-lg overflow-hidden cursor-pointer transition-transform duration-300 mb-9 last:mb-0 hover:scale-105">
          <img 
            src="${img}" 
